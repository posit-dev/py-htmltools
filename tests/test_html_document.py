...
def test_save_html_utf8_encoding(monkeypatch):
    """save_html() should write files with UTF-8 encoding to handle non-ASCII characters."""
    from unittest.mock import call

    from htmltools import HTML

    # U+2212 (MINUS SIGN) is commonly generated by matplotlib in SVG axis labels
    # and cannot be encoded in cp1252 (Windows default)
    doc = HTMLDocument(HTML("<p>Temperature: \u22125\u00b0C</p>"), lang="en")

    # Track calls to builtins.open to verify encoding="utf-8" is passed,
    # ensuring the test is deterministic even on systems defaulting to UTF-8.
    import builtins
